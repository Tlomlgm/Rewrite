...
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/Tlomlgm/Rewrite/main/Revenuecat.js


[mitm] 
hostname = api.revenuecat.com,api-paywalls.revenuecat.com
...
if (typeof $response == "undefined") {
  ...
  const UAMappings = {
    ...
    'PrevisShot':{ name: 'VIP', id: 'com.previsshot.previsshot.continuous_subscribe_12 个月之前_vip'},//7.9
