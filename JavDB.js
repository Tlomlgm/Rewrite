...
^https:\/\/(api\.(yijingluowangluo|hechuangxinxi)\.xyz|jdforrepam\.com)\/api\/(v1\/(ads|startup|users)|v4\/(movies|plans)\/\w+) url script-response-body https://raw.githubusercontent。com/Tlomlgm/Cite/main/JavDB-DaTa.js
